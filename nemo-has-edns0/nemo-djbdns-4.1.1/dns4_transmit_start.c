...
int dns4_transmit_start(struct dns4_transmit *dt, ip4_vector *servers, unsigned int flag_recursive, const dns_domain *qname, const dns_type *qtype, const ip4_address *localip)
{
  register byte_t *buf;
